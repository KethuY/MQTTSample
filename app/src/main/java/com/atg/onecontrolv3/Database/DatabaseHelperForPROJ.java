...
public class DatabaseHelperForPROJ extends SQLiteOpenHelper {
    ...
    private static final String TAG = DatabaseHelperForPROJ.class.getSimpleName();
    private static String DB_NAME = "OC_IR_BLASTER_PROJ";
    private static String TABLE_IR_BLASTER = "IR_BLASTER_PROJ";
    //    public static final String KEY_STATUS = "key_status"; //value

    public DatabaseHelperForPROJ(Context context) {
