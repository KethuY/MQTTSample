...
/**
 * Created by Bharath on 11-Jul-17
 */
...
public class DatabaseHelperForAC extends SQLiteOpenHelper {
    ...
    private static final String TAG = DatabaseHelperForAC.class.getSimpleName();
    private static String DB_NAME = "OC_IR_BLASTER_AC";
    private static String TABLE_IR_BLASTER = "IR_BLASTER_AC";
