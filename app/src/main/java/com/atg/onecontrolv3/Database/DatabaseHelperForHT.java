...
public class DatabaseHelperForHT extends SQLiteOpenHelper {
    ...
    private static String DB_NAME = "OC_IR_BLASTER_HT";
    private static String TABLE_IR_BLASTER = "IR_BLASTER_HT";
    //    public static final String KEY_STATUS = "key_status"; //value

    public DatabaseHelperForHT(Context context) {
