...
/**
 * Created by Bharath on 12-Jul-17
 */

public class DatabaseHelperForMP extends SQLiteOpenHelper {
    ...
    private static final String TAG = DatabaseHelperForHT.class.getSimpleName();
    private static String DB_NAME = "OC_IR_BLASTER_MP";
    private static String TABLE_IR_BLASTER = "IR_BLASTER_MP";
    //    public static final String KEY_STATUS = "key_status"; //value

    public DatabaseHelperForMP(Context context) {
