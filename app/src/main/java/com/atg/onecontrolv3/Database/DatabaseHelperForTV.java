...
public class DatabaseHelperForTV extends SQLiteOpenHelper {
    ...
    private static final String TAG = DatabaseHelperForTV.class.getSimpleName();
    private static String DB_NAME = "OC_IR_BLASTER_TV";
    private static String TABLE_IR_BLASTER = "IR_BLASTER_TV";
    //    public static final String KEY_STATUS = "key_status"; //value

    public DatabaseHelperForTV(Context context) {
...
//                + KEY_STATUS + " TEXT" + ")";
    ...
    public long addIRDevice(IRAppliancesModel model) {
        ...
        try {
            ...
            /*values.put(APPLIANCE_TYPE, model.getAppliance_type());*/
            values.put(KEY_NAME, model.getKey_name());
            values.put(KEY_VALUE, model.getValue());
//          values.put(KEY_STATUS, model.getKey_status());
    ...
    public byte[] getIRDeviceKeyValue(String chipId, String keyName, String roomId, String applianceNo, String applianceType) {
        ...
        Cursor cursor = db.query(TABLE_IR_BLASTER,
                ...
                MAC_ID + "=? AND "
                        ...
                        + KEY_NAME + "=?"
                        /*+ APPLIANCE_TYPE + "=?"*/,
                new String[]{Utils.MAC_ID, roomId, applianceNo, chipId, keyName/*, applianceType*/},
                null, null, null, null);
    ...
    public ArrayList<IRSendKeysModel> getApplianceIRValues(String chipId, String roomId, String applianceNo, String applianceType) {
        SQLiteDatabase db = this.getReadableDatabase();
    ...
    public long updateIRDeviceKeyValue(String chipId, String roomId, String applPos, String applType, String keyName, byte[] keyValue, String userId, String password) {
        SQLiteDatabase db = this.getWritableDatabase();
        ...
        long id = db.update(TABLE_IR_BLASTER, values,
                MAC_ID + "=? AND "
                        ...
                        + KEY_NAME + "=?"
                        /*+ APPLIANCE_TYPE + "=?"*/,
                new String[]{Utils.MAC_ID, roomId, chipId, applPos, keyName/*, applType*/});
        db.close();

        return id;
    }

    /*public boolean isIRKeyExists(String roomId, String appPos, String zmoteId, String keyName) {
        boolean isExists = false;
        Cursor cursor = null;
        SQLiteDatabase db = this.getReadableDatabase();

        try {
            db.rawQuery("SELECT * FROM " + TABLE_IR_BLASTER
                    + " WHERE " + MAC_ID + "")
        } catch (Exception e) {
            Log.e(TAG, "isKey existsException:-:" + e.getMessage());
        }
        return false;
    }*/
    ...
    public boolean isKeyValueExists(String chipId, String keyName, boolean isInitialCheck) {
        ...
        SQLiteDatabase db = this.getReadableDatabase();
        try {
//            Cursor cursor = db.rawQuery("SELECT " + "length(" + keyValue.toString() + ")" + " FROM " + TABLE_IR_BLASTER
//                    + " WHERE " + KEY_NAME + "=" + "'" + keyName + "'", null);
            if (isInitialCheck) {
...
//    public String getKeyStatus(String keyName){
//        String status = "";
//        SQLiteDatabase db = this.getReadableDatabase();
//        Cursor cursor = db.query(TABLE_IR_BLASTER,
//                new String[]{KEY_STATUS},
//                KEY_NAME + "=?",
//                new String[]{keyName},
//                null, null, null, null);
//
