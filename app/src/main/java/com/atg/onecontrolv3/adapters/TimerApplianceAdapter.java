...
public class TimerApplianceAdapter extends BaseAdapter {
    private static final String TAG = TimerApplianceAdapter.class.getSimpleName();
    ...
    public TimerApplianceAdapter(Context context, ArrayList<GetMacInfoModel> getMacInfoArrLst, OnItemClickListener mListener) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.timer_appliance_item, parent, false);
    ...
    private void setAppStatus(TextView appOneTV, String g, String s) {
        /*String apptype = String.valueOf(s.charAt(1));
        if (apptype.equals("@")) {
            Typeface typeface = Typeface.createFromAsset(context.getAssets(), "uifont.ttf");
            appOneTV.setTypeface(typeface);
            ...
            if (appStatusStr.equals("1")) {
                ...
                appOneTV.setTextColor(colorPrimaryDark);
            } else {
